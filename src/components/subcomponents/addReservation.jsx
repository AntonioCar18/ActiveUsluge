...
const AddReservation = ({ onClose, onAdd }) => {
            ...
            <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto flex flex-col">
                <div className="flex items-center justify-between px-6 py-5 border-b border-slate-100">
                    <div className="flex flex-col">
                        <h2 className="text-lg font-bold">Dodaj rezervaciju</h2>
                        <p className="text-sm text-slate-500">Popuni podatke o novoj rezervaciji</p>
                    </div>
                    ...
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <div className="flex flex-col gap-2 mt-2 max-h-48 overflow-y-auto">
                            {equipmentList?.map((e) => {
                                ...
                                const isUnavailable = e.real_available <= 0;
                                return (
                                    <label
                                        key={e.id}
